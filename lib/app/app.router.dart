...
import 'package:bnbit_app/data_model/business/business_model.dart' as _i36;
import 'package:bnbit_app/data_model/time_range/time_range.dart' as _i37;
...
import 'package:bnbit_app/ui/views/set_trading_hours/set_trading_hours_view.dart'
    as _i24;
import 'package:bnbit_app/ui/views/settings/settings_view.dart' as _i34;
...
class Routes {
  ...
  static const viewImagesView = '/view-images-view';

  static const deleteAccountView = '/delete-account-view';

  static const seeAllServicesView = '/see-all-services-view';
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      Routes.viewImagesView,
      page: _i31.ViewImagesView,
    ),
    _i1.RouteDef(
      Routes.deleteAccountView,
      page: _i32.DeleteAccountView,
    ),
    _i1.RouteDef(
      Routes.seeAllServicesView,
      page: _i33.SeeAllServicesView,
    ),
    _i1.RouteDef(
      Routes.settingsView,
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i31.ViewImagesView: (data) {
      final args = data.getArgs<ViewImagesViewArguments>(nullOk: false);
      return _i35.MaterialPageRoute<dynamic>(
        builder: (context) => _i31.ViewImagesView(
            key: args.key, images: args.images, index: args.index),
        settings: data,
      );
    },
    _i32.DeleteAccountView: (data) {
      return _i35.MaterialPageRoute<dynamic>(
        builder: (context) => const _i32.DeleteAccountView(),
        settings: data,
      );
    },
    _i33.SeeAllServicesView: (data) {
      final args = data.getArgs<SeeAllServicesViewArguments>(nullOk: false);
      return _i35.MaterialPageRoute<dynamic>(
        builder: (context) => _i33.SeeAllServicesView(
            key: args.key, businessServices: args.businessServices),
        settings: data,
      );
    },
...
class VerifyOtpViewArguments {
  ...
  @override
  String toString() {
    return '{"key": "$key", "phoneNumber": "$phoneNumber", "password": "$password", "isNewUser": "$isNewUser"}';
  }
...
class SetScheduleViewArguments {
  ...
  final Map<String, _i37.TimeRange?>? tradingHours;
...
class SelectLocationViewArguments {
  ...
  final List<_i36.Business> businesses;
...
class ViewImagesViewArguments {
  const ViewImagesViewArguments({
    this.key,
  ...
  @override
  String toString() {
    return '{"key": "$key", "images": "$images", "index": "$index"}';
  }

  @override
  bool operator ==(covariant ViewImagesViewArguments other) {
    if (identical(this, other)) return true;
    return other.key == key && other.images == images && other.index == index;
  }

  @override
  int get hashCode {
    return key.hashCode ^ images.hashCode ^ index.hashCode;
  }
}

class SeeAllServicesViewArguments {
  const SeeAllServicesViewArguments({
    this.key,
  ...
  final List<_i36.BusinessServiceModel> businessServices;

  @override
  String toString() {
    return '{"key": "$key", "businessServices": "$businessServices"}';
  }

  @override
  bool operator ==(covariant SeeAllServicesViewArguments other) {
    if (identical(this, other)) return true;
    return other.key == key && other.businessServices == businessServices;
  }

  @override
  int get hashCode {
    return key.hashCode ^ businessServices.hashCode;
  }
}
...
extension NavigatorStateExtension on _i38.NavigationService {
  ...
  Future<dynamic> navigateToBusinessDetailView({
    _i35.Key? key,
    required _i36.Business business,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToSetScheduleView({
    _i35.Key? key,
    Map<String, _i37.TimeRange?>? tradingHours,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToSelectLocationView({
    _i35.Key? key,
    required List<_i36.Business> businesses,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToViewImagesView({
    _i35.Key? key,
    ...
    return navigateTo<dynamic>(Routes.viewImagesView,
        arguments:
            ViewImagesViewArguments(key: key, images: images, index: index),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> navigateToSeeAllServicesView({
    _i35.Key? key,
    required List<_i36.BusinessServiceModel> businessServices,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.seeAllServicesView,
        arguments: SeeAllServicesViewArguments(
            key: key, businessServices: businessServices),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithViewImagesView({
    _i35.Key? key,
    required List<String> images,
    int index = 0,
    int? routerId,
    ...
    return replaceWith<dynamic>(Routes.viewImagesView,
        arguments:
            ViewImagesViewArguments(key: key, images: images, index: index),
        id: routerId,
        preventDuplicates: preventDuplicates,
  ...
  Future<dynamic> replaceWithSeeAllServicesView({
    _i35.Key? key,
    required List<_i36.BusinessServiceModel> businessServices,
    int? routerId,
    bool preventDuplicates = true,
    ...
    return replaceWith<dynamic>(Routes.seeAllServicesView,
        arguments: SeeAllServicesViewArguments(
            key: key, businessServices: businessServices),
        id: routerId,
        preventDuplicates: preventDuplicates,
